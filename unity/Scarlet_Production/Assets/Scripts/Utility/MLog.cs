...
public class MLog : MonoBehaviour {
    ...
    private static bool[] s_EnabledTypes = {false, false, false, false, false, false, false, false, false };
...
public enum LogType
{
    Verbose, Debug, Warning, Error, BattleLog, AELog, FairyLog, DHLog, AngelLog
}
