    ...
    SubShader {
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
                ...
                fixed2 baseAnimation = (_Time.g + _TimeEditor.g) * 0.001 * (_WindDir.rg * _Offset) + _CloudsMap_ST.ba;
			  ...
			  // _MainTex = fixed4(cloudMorph,cloudMorph,cloudMorph,1);
